...
- [`scripts/check_updates.py`](../scripts/check_updates.py)
  - **Назначение:** автоматическая проверка обновлений экосистемы (Claude Code, orx, agy, pytest, доступность кластера) через PyPI, npm registry и локальные бинарники.
