...
- `mcp__claude-local-delegate__delegate_to_local`: Dispatch atomic coding/testing tasks to Tier 0 local workers (Qwen 27B).
...
8. **Cost-Aware Routing (ProgRouter)**: Use the local Qwen 27B workers for 80-90% of routine coding and searches. Retain complex architectural synthesis for yourself (Tier 1).
